...
import  {titleClassName,headerclass}  from "../app/data";
...
<Image src={chai} alt="chia" className="bg-cover w-full  "/>
 <div className=" bg-white w-[28rem]  absolute top-1/3 left-1/12 text-lg font-bold text-red-700 p-5" >
    <div className="flex flex-col gap-4">
      ...
      <p className={titleClassName}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam et purus a odio finibus bibendum amet leo. </p>
    ...
    <section className=" pt-20">
      <div className="flex gap-8 max-w-6xl  w-full mx-auto  " >

<Image src={avocado} alt="chia" height={300}  className=" w-[62%]  rounded-xl  "/>
<div className="py-16">
  <p className={headerclass}>We pride ourselves on making real food from the best ingredients.</p>
  <p className={titleClassName}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam et purus a odio finibus bibendum in sit amet leo. Mauris feugiat erat tellus.</p>
 <button  className="p-7 bg-[#a82d49] text-white  md:p-2 opacity-40 transition-all delay-75 ease-in-out hover:opacity-90 focus:outline-none"
...
<div className="py-16">
  <p className={headerclass}>We make everything by hand with the best possible ingredients.</p>
  <p className={titleClassName}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam et purus a odio finibus bibendum in sit amet leo. Mauris feugiat erat tellus.Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
 <button  className="p-7 bg-[#a82d49] text-white  md:p-2 opacity-40 transition-all delay-75 ease-in-out hover:opacity-90 focus:outline-none"
         ><Link href="#">Learn More  </Link></button>
         
</div>

<Image src={cake} height={400} alt="chia"  className="bg-cover w-[62%] rounded-xl   object-top"/>
